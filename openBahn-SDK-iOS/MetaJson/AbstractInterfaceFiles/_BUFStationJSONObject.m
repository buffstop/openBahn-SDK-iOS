...
- (id)initWithDictionary:(NSDictionary *)dic  withError:(NSError **)error {
    ...
    if (self) {
        ...
        self.nahverkehr = [BUFAPIParser stringFromResponseDictionary:dic forKey:@"nahverkehr" acceptNumber:NO acceptNil:YES error:error];
        if (*error) {
            return self;
        }
        ...
        self.katVst = [BUFAPIParser stringFromResponseDictionary:dic forKey:@"katVst" acceptNumber:NO acceptNil:YES error:error];
        if (*error) {
            return self;
        }
        ...
        self.bfNr = [BUFAPIParser stringFromResponseDictionary:dic forKey:@"bfNr" acceptNumber:NO acceptNil:YES error:error];
        if (*error) {
            return self;
        }
    }
