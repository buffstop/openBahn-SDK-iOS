...
NSInteger const kBUFErrorDomain_parser_protocolError = 1;
NSInteger const kBUFErrorDomain_parser_dictionaryExpected = 2;
NSInteger const kBUFErrorDomain_parser_arrayExpected = 3;
NSInteger const kBUFErrorDomain_parser_numberExpected = 4;
NSInteger const kBUFErrorDomain_parser_stringExpected = 5;
NSInteger const kBUFErrorDomain_parser_dateExpected = 6;
NSInteger const kBUFErrorDomain_parser_keyNotFound = 7;
NSInteger const kBUFErrorDomain_parser_indexNotFound = 8;
NSInteger const kBUFErrorDomain_parser_valueIsNull = 9;
NSInteger const kBUFErrorDomain_parser_dataExpected = 10;
NSInteger const kBUFErrorDomain_parser_valueIsNotValid = 11;

NSString * const kBUFErrorDomain_parser = @"BUFParser";

NSString * const kBUFErrorDomain_parser_userInfoKey = @"BUFParserAttributeName";
NSString * const kBUFErrorDomain_parser_userInfoValue = @"BUFParserAttributeValue";

#ifndef BUF_ASSURE_ERROR
#define BUF_ASSURE_ERROR(error)                                              \
if (!(error)) (error) = (NSError*__autoreleasing*)alloca(sizeof(NSError*));                       \
*(error) = nil;
#endif

@implementation BUFAPIParser
...
+(NSDate *)dateFromISO8601String:(NSString *)timeString error:(NSError**)error {
    ...
    if (!date) {
        *error = [NSError errorWithDomain:kBUFErrorDomain_parser code:kBUFErrorDomain_parser_dateExpected userInfo:nil];
        return nil;
    }
...
+(id)objectFromResponseArray:(id)responseObject
    ...
    {
        *error = [NSError errorWithDomain:kBUFErrorDomain_parser code:kBUFErrorDomain_parser_arrayExpected userInfo:nil];
        return nil;
    }
    ...
    if (index >= [responseArray count]) {
        if (!acceptNil) {
            *error =[NSError errorWithDomain:kBUFErrorDomain_parser code:kBUFErrorDomain_parser_indexNotFound userInfo:nil];
        }
        return nil;
    }
    ...
    if (!object || object == [NSNull null]) {
        if (!acceptNil) {
            *error =[NSError errorWithDomain:kBUFErrorDomain_parser code:kBUFErrorDomain_parser_valueIsNull userInfo:nil];
        }
        return nil;
    }
...
+(NSDictionary*)dictionaryFromResponseArray:(id)responseObject
    ...
    {
        *error = [NSError errorWithDomain:kBUFErrorDomain_parser code:kBUFErrorDomain_parser_dictionaryExpected userInfo:nil];
        return nil;
    }
...
+(NSString *)stringFromResponseArray:(id)responseObject
    ...
    {
        *error = [NSError errorWithDomain:kBUFErrorDomain_parser code:kBUFErrorDomain_parser_stringExpected userInfo:nil];
        return nil;
    }
...
+(NSNumber *)numberFromResponseArray:(id)responseObject
    ...
    {
        *error = [NSError errorWithDomain:kBUFErrorDomain_parser code:kBUFErrorDomain_parser_numberExpected userInfo:nil];
        return nil;
    }
    
    NSNumber *BUFNumber = [NSNumber numberWithLongLong:[number longLongValue]];
    return (NSNumber*)BUFNumber;
}
                           ...
                           error:(NSError**)error
{
    ...
    if (![data isKindOfClass:[NSData class]]) {
        *error = [NSError errorWithDomain:kBUFErrorDomain_parser code:kBUFErrorDomain_parser_dataExpected userInfo:nil];
        return nil;
    }
                            ...
                            error:(NSError**)error
{
    ...
    if (!object) {
        if (!acceptNil) {
            *error =[NSError errorWithDomain:kBUFErrorDomain_parser code:kBUFErrorDomain_parser_keyNotFound userInfo:@{kBUFErrorDomain_parser_userInfoKey: key}];
        }
        return nil;
    }
    if (object == [NSNull null]) {
        if (!acceptNil) {
            *error =[NSError errorWithDomain:kBUFErrorDomain_parser code:kBUFErrorDomain_parser_valueIsNull userInfo:@{kBUFErrorDomain_parser_userInfoKey: key}];
        }
        return nil;
    }
